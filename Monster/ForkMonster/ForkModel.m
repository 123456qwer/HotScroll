...
@implementation ForkModel
- (void)setTextures
{
    NSArray *images = [WDCalculateTool arrWithLine:3 arrange:6 imageSize:CGSizeMake(1020, 510) subImageCount:18 image:[UIImage imageNamed:@"axe"]];
