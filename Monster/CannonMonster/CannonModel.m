...
@implementation CannonModel
- (void)setTextures
{
    NSArray *images = [WDCalculateTool arrWithLine:3 arrange:6 imageSize:CGSizeMake(1020, 510) subImageCount:16 image:[UIImage imageNamed:@"cannon"]];
