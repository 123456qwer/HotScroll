...
- (void)monsterAttackAction {
    ...
    blueFire.particleColorSequence = nil;
    blueFire.particleColorBlendFactor = 1.0;
    blueFire.particleColor = [SKColor brownColor];
